    ...
    <div class="grid grid-cols-10 gap-8">
        <div class="col-span-7">
            ...
            <p class="text-slate-500 mb-10">
                Complete the simulation to earn credentials
                for diagnosing and treating the following ailments.
                Utilize both qualitative and quantitative data
                to make accurate diagnoses and treatment decisions. Remember, you will be evaluated based on both speed and accuracy!
            </p>
            <section>
